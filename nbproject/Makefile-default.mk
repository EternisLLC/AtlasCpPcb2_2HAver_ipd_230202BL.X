...
FINAL_IMAGE=dist/${CND_CONF}/${IMAGE_TYPE}/AtlasCpPcb2_2HAver_ipd_230202BL.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk dist/${CND_CONF}/${IMAGE_TYPE}/AtlasCpPcb2_2HAver_ipd_230202BL.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
dist/${CND_CONF}/${IMAGE_TYPE}/AtlasCpPcb2_2HAver_ipd_230202BL.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk  ezbl_integration/ezbl_lib.a ezbl_integration/AtlasCP_pcb2_BOOT_220119.X.merge.gld
	...
	${MP_CC_DIR}\\xc16-bin2hex dist/${CND_CONF}/${IMAGE_TYPE}/AtlasCpPcb2_2HAver_ipd_230202BL.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX} -a  -omf=elf   -mdfp=${DFP_DIR}/xc16 
